...
public class Bouton extends JButton implements MouseListener {
    ...
    public Bouton(String str) {
        ...
        this.name = str;
        try {
            img = ImageIO.read(new File("src/com/company/fondBouton.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void mouseEntered(MouseEvent event) {
        ...
        try {
            img = ImageIO.read(new File("src/com/company/fondBoutonHover.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void mousePressed(MouseEvent event) {
        ...
        try {
            img = ImageIO.read(new File("src/com/company/fondBoutonClic.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
